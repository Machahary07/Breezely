...
document.querySelectorAll('.premium-dropdown').forEach(dropdown => {
    const btn = dropdown.querySelector('.premium-dropdown-btn');
    const menu = dropdown.querySelector('.premium-dropdown-menu');
    const targetSelect = dropdown.querySelector('select');
    ...
    menu.querySelectorAll('.premium-dropdown-item').forEach(item => {
        item.addEventListener('click', () => {
            menu.querySelectorAll('.premium-dropdown-item').forEach(i => i.classList.remove('active'));
